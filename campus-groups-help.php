               ...
               <div class="row">
                 <div class="col-xs-12">
                   <div class="block content-header">
                     <h2>Help Section</h2>
                     <p>Questions about Campus Groups? Take a look at the resources listed below for an answer.</p>
                   </div>
                 </div>
               </div>
               <!-- CONTENT HEADER END -->
               ...
               <div class="row">
                 <div class="col-xs-12">
                   <div class="block content-body">
                     <h3>About</h3>
                     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque vulputate, justo a porttitor ultrices, nibh urna elementum enim, quis imperdiet justo magna eleifend nibh.</p>
                   </div>
                 </div>
               </div>
               <!-- CONTENT BODY END -->     
                             ...
                             <div class="panel-heading">
                               <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                   <span class="glyphicon glyphicon-plus-sign"></span> Collapsible Group Item
                                 </a>
                               </h4>
                             </div>
